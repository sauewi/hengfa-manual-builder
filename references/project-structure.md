...
Use this standard for industrial and non-standard equipment manual projects.
...
| `项目管理` | Project board, compact handoff, SFC review, feedback handling | Treat as the source of truth for workflow state. |
| `输出` | Screenshots, contact sheets, static audits, verification artifacts | Keep internal checks here. |
